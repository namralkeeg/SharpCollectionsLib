...
namespace Keeg.SharpCollectionsLib.Tests.Sorting
{
    public class CycleSortTests
    {
        ...
        internal static ISortAlgorithm<int> defaultSort = new CycleSort<int>();
        internal static ISortAlgorithm<int> customSort = new CycleSort<int>(new SortCustomComparer());
