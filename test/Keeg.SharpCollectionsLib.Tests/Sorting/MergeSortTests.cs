...
namespace Keeg.SharpCollectionsLib.Tests.Sorting
{
    public class MergeSortTests
    {
        ...
        internal static ISortAlgorithm<int> defaultSort = new MergeSort<int>();
        internal static ISortAlgorithm<int> customSort = new MergeSort<int>(new SortCustomComparer());
