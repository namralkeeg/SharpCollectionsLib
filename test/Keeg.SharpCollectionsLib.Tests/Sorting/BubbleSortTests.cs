...
namespace Keeg.SharpCollectionsLib.Tests.Sorting
{
    public class BubbleSortTests
    {
        ...
        internal static ISortAlgorithm<int> defaultBubbleSort = new BubbleSort<int>();
        internal static ISortAlgorithm<int> customBubbleSort = new BubbleSort<int>(new BubbleSortCustomComparer());

        internal class BubbleSortCustomComparer : Comparer<int>
        {
        ...
        public void Sort_SortEntireListDefaultCompare()
        {
            ...
            defaultBubbleSort.Sort(tempArray);
        ...
        public void Sort_SortEntireListCustomCompare()
        {
            var tempArray = new int[10];
            testArray.CopyTo(tempArray, 0);
            customBubbleSort.Sort(tempArray);
        ...
        public void Sort_StressTestDefaultCompare()
        {
            ...
            defaultBubbleSort.Sort(randomList);
        ...
        public void Sort_StressTestCustomCompare()
        {
            ...
            customBubbleSort.Sort(randomList);
            for (int i = 0; i < nodes; i++)
            {
                Assert.Equal(i, randomList[i]);
            }
