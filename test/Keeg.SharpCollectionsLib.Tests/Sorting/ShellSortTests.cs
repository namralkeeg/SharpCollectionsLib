...
namespace Keeg.SharpCollectionsLib.Tests.Sorting
{
    public class ShellSortTests
    {
        ...
        internal static ISortAlgorithm<int> defaultSort = new ShellSort<int>();
        internal static ISortAlgorithm<int> customSort = new ShellSort<int>(new SortCustomComparer());
